...
from models.transformer.transformer_trainer import TransformerTrainer, TransformerProgressiveTrainer
...
if __name__ == '__main__':
    ...
    if opt.prog_training:
        trainer = TransformerProgressiveTrainer(opt, t2m_transformer, vq_model)
    else:
