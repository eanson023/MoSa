...
if __name__ == "__main__":
    ...
    # converter = Joint2BVHConvertor()
    converter = Joint2BVHConvertor()
    file = "/mnt/07b5edc6-c6ec-4c22-bd14-51ca54d8a7fc/YanSheng/momask-codes/bvh_test/momask/000000.npy"
    
    joints = np.load(file)
    converter.convert(joints, file.replace('.npy', '.bvh'), foot_ik=True)
