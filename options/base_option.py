...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset_name', type=str, default='t2m', choices=['t2m', 'kit', 'motionx'], help='Dataset Name, {t2m} for humanml3d, {kit} for kit-ml')
        ...
        self.parser.add_argument('--ff_size', type=int, default=768, help='FF_Size')
    ...
    def parse(self):
        ...
        if hasattr(self.opt, 'tiny') and self.opt.tiny:
            self.opt.n_layers = 1
